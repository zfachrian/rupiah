        ...
        <article class="card-body mx-auto" style="max-width: 800px;">
            ...
            <form method="POST" action="<?= base_url('Kader/historiSelesai'); ?>" class="float-right mt-4 mb-5">
                <div class="form-group input-group">
                    ...
                    <input type="button" class="btn btn-fill-standart shadow" value="Search" name="cari1" id="cari1">
                </div>
            </form>
            ...
            <table class="table-history">
                ...
                foreach ($cari as $car) { ?>
                    <tr class="text-center">
                        <td><label><?= $car['NO_IDENTITAS']; ?></td>
                        <td><label><?= $car['NAMA']; ?></label></td>
                        <td><label class="green-rujuk-no-hover">Selesai</td>
                        <td><a type="submit" class="btn-fill detail-btn" href='<?= base_url(''); ?>Kader/detailSelesai/<?= $car['ID_RUJUKAN']; ?>'>Lihat Detail</a></td>
                    </tr>
                <?php
                    $num++;
                } ?>
